...
class MenuScene extends Phaser.Scene {
    ...
    create() {
        ...
        const buttons = [
            ...
            { text: '🎁 Рефералы', y: CONSTS.HEIGHT / 2 + 105, callback: () => this.scene.start('ReferralScene') },
            { text: '🎒 Инвентарь', y: CONSTS.HEIGHT / 2 + 160, callback: () => this.scene.start('InventoryScene') },
            { text: '💎 Кошелёк', y: CONSTS.HEIGHT / 2 + 215, callback: () => this.scene.start('WalletScene') },
            { text: '⭐ Магазин', y: CONSTS.HEIGHT / 2 + 270, callback: () => this.openWebShop() },
        ];
...
const config = {
    ...
    scene: [MenuScene, LeaderboardScene, InventoryScene, StatsScene, WalletScene, ReferralScene, MatchmakingScene, DuelHistoryScene, GameScene]
};
